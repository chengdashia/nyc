package git.bds.nyc.framework.file.minio;//package com.git.bds.nyc.util.minio;


import cn.hutool.core.date.DateTime;
import cn.hutool.core.util.IdUtil;
import git.bds.nyc.exception.BusinessException;
import git.bds.nyc.framework.file.core.util.thumbnailator.ThumbnailUtil;
import io.minio.*;
...
import static git.bds.nyc.constant.Constants.POINT;
import static git.bds.nyc.constant.Constants.SEPARATOR;
