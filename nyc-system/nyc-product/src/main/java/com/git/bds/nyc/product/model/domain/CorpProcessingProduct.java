...
@TableName("corp_processing_product")
@ApiModel(value = "CorpProcessingProduct对象", description = "加工产品表")
public class CorpProcessingProduct extends Model<CorpProcessingProduct> {
